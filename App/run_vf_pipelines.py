    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "DB_USER": os.getenv("DB_USER", "loca"),                                  # User to connect to the database with
                "DB_PASSWORD": os.getenv("DB_PASSWORD", "digiloca"),                          # Password to connect to the database with
                "DB_DATABASE": os.getenv("DB_DATABASE", "app"),                          # Database to select on the DB instance
